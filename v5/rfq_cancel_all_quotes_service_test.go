...
func TestRFQCancelAllQuotesService_Do(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if got, want := r.URL.Path, "/api/v5/rfq/cancel-all-quotes"; got != want {
	...
	ack, err := c.NewRFQCancelAllQuotesService().Do(context.Background())
	if err != nil {
