...
func TestRFQMMPConfigService_Do(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{"code":"0","msg":"","data":[{"frozenInterval":"2000","mmpFrozen":true,"mmpFrozenUntil":"1000","countLimit":"10","timeInterval":"5000"}]}`))
	}))
	t.Cleanup(srv.Close)
	...
	if len(cfg) != 1 || cfg[0].TimeInterval != "5000" || !cfg[0].MMPFrozen {
		t.Fatalf("cfg = %#v", cfg)
	}
}
