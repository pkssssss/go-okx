...
- 频道（已解析）：K 线 `candle*`、标记价格 K 线 `mark-price-candle*`、指数 K 线 `index-candle*`、`trades-all`、`sprd-public-trades`、`sprd-tickers`、SPRD K 线 `sprd-candle*`、SPRD 深度 `sprd-bbo-tbt/sprd-books5/sprd-books-l2-tbt`
