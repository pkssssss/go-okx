...
- REST 公共/行情：`public_time`、`public_instruments`、`funding/funding-rate-history/open-interest/mark-price/price-limit/opt-summary/instrument-tick-bands/insurance-fund/convert-contract-coin/underlying/estimated-price/premium-history`、`market_(books/books-full/books-sbe/candles/tickers/trades/index-tickers)`
